...
export const arabicWhitePapers: LocalizedPublicationPage[] = [
  defineArabicPage({
    ...
    sections: [
      ...
      { heading: 'المحتويات', bullets: ['مشكلة الربط في القراءة القصيرة', `${isolateLtr(pseqArchitecture.name)} ومبادئ التصميم`, 'نموذج التشغيل من البداية إلى النهاية', 'ثلاثة مكونات مترابطة للمنصة', 'التحليل على مستوى الجزيء وقابلية تتبع الأدلة', 'نموذج النشر والمخرجات والحدود الحالية'] },
    ],
    whitePaper: {
