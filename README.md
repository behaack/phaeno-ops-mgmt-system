...
- `modules/PSeq.Operations.Commercial/Crm`: first-party CRM relationship records, with the durable Company as the canonical customer record and an optional internal tenant scope for Portal access.
