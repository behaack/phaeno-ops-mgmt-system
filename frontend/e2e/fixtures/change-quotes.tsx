...
import { type LabServiceOrder, type OrderConfiguration, type Quote } from '../../src/api/order-management'
...
const catalog = [{ id: '44444444-4444-4444-8444-444444444444', name: 'Accepted PSeq service', isPSeqLabService: true, isActive: true, salesUnit: 'specimen', basePrice: 100 }] as OrderConfiguration['catalogItems']
function App() {
