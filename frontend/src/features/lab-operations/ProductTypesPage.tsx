...
import { z } from 'zod'
import { reagentProductTypeId, transportationKitProductTypeId, useProductTypes, saveProductType, productTypesKey, supplierCatalogKey, productKindLabel, type ProductType } from '#/api/supplier-catalog'
