...
export const departmentMessagesByLocale = {
  'en-US': {
    ...
    name: 'Name', reference: 'Reference', description: 'Description',
    referenceAssignedOnSave: 'A department reference is assigned automatically when saved.',
    referencePermanent: 'This reference stays the same if the department is renamed.',
    ...
    inviteTitle: 'Invite to Portal',
    inviteContactTitle: (name: string) => `Invite ${name} to Portal`,
    inviteDescription: 'Send an email invitation. The recipient will receive the access selected below only after accepting.',
    invitationRecipient: 'Recipient', invitationOrganization: 'Organization',
    invitationAccess: 'Access after acceptance',
    memberDescription: 'Access only the departments selected below. No organization administrator permissions.',
