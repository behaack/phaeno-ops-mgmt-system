...
function sourceLabel(value: string) { return value === 'ProspectTrialProject' ? 'Trial Project' : value === 'CustomerLabServiceOrder' ? 'Customer lab job' : value === 'CustomerPromotionalOrder' ? 'Customer promotional order' : humanize(value) }
