...
describe('standard kit preparation and dispatch', () => {
  it('requires expiration for additional configured products and submits the displayed past date', async () => {
    ...
    fill(/Kit configuration/, definition.id)
