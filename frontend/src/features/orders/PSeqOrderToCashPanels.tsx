    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          ...
          blockers; quote issuance still requires full readiness.
        </CardDescription>
      </CardHeader>
