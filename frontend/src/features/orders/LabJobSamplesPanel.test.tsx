...
describe('Customer sample-list authorization', () => {
  ...
  it('paginates ten lexically ordered sample IDs across source groups with whole-group counts', () => {
    ...
    expect(screen.getByText('13 of 13 sample IDs saved · 13 of 13 sample-sequencing runs allocated')).toBeTruthy()
  ...
  it('clears saved details with confirmation and restores the accepted empty slot with one tube', async () => {
    ...
    expect(screen.getByText('0 of 1 sample IDs saved · 0 of 1 sample-sequencing runs allocated')).toBeTruthy()
