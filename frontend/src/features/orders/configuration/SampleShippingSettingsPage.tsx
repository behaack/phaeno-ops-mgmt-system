...
export function SampleShippingSettingsPage({ section, onSectionChange, sampleTypeId, procedureId }: {
  ...
  if (!canManage) return <main className="page-wrap px-4 py-8"><Alert variant="destructive"><AlertTitle>Samples & shipping unavailable</AlertTitle><AlertDescription>A Phaeno platform administrator is required.</AlertDescription></Alert></main>

  return <main className="py-8">
    <WorkspaceSidebar workspaceLabel="Samples & shipping" items={shippingSettingsSections} value={section} onValueChange={onSectionChange}>
      <div className="page-wrap px-4 pt-6 lg:pt-0">
        <header className="mb-6">
          <h1 className="text-3xl font-semibold">Samples &amp; shipping</h1>
