...
export function ShippingContainerDetailPage({ containerId }: { containerId: string }) {
  ...
  return <main className="page-wrap px-4 py-8"><Link className="inline-flex items-center gap-1 text-sm text-primary underline underline-offset-2" to="/sample-shipping-settings" search={{ ...parseShippingContainerListSearch(search), shippingSection: 'containers' }} hash="container-sizes"><ArrowLeft aria-hidden="true" className="size-4" />Back to kit specifications</Link>
