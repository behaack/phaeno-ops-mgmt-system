...
export const documentationEntries: readonly DocumentationEntry[] = [
  ...
  },
  {
    ...
    summary: 'Understand result readiness, credit and payment holds, and POMS billing records.',
    section: 'Laboratory work',
    order: 40,
  ...
  },
  {
    ...
    summary: 'Apply accounting-source, credit, payment-hold, file, and readiness gates without conflating state.',
    section: 'Order operations',
    order: 45,
    reviewedAt: '2026-08-26',
