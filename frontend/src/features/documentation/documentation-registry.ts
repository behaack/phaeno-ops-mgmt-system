...
export const documentationEntries: readonly DocumentationEntry[] = [
  ...
  },
  {
    ...
    slug: 'account-and-access',
    title: 'Account and access',
    summary: 'Accept invitations, interpret delivery state, complete MFA, confirm the current organization, and resolve access problems.',
    section: 'Basics',
    order: 20,
  ...
  },
  {
    ...
    summary: 'Understand governed PSeq result status, native POMS invoices, and payment-independent release.',
    section: 'Laboratory work',
    order: 40,
    reviewedAt: '2026-08-29',
  ...
  },
  {
    ...
    summary: 'Manage derived readiness, durable invitations, explicit roles, organizations, services, and access.',
  ...
  },
  {
    ...
    summary: 'Stage PSeq demand, manage all order types, and use role-owned order-to-cash operations.',
  ...
  },
  {
    ...
    parentSlug: 'order-operations',
    title: 'PSeq AR and result release',
    summary: 'Operate native PSeq AR and payment-independent result release while preserving Partner rules.',
    section: 'Order operations',
    order: 45,
    reviewedAt: '2026-08-29',
  ...
  },
  {
    ...
    parentSlug: 'order-operations',
    title: 'Accounting and notification recovery',
    summary: 'Reconcile manual journal-entry sources and safely retry notification deliveries.',
    section: 'Order operations',
    order: 46,
    reviewedAt: '2026-08-27',
  ...
  },
  {
    ...
    summary: 'Review complete lineage and clean final artifacts, pin the package, and publish readiness.',
    section: 'Laboratory operations',
    order: 58,
    reviewedAt: '2026-08-29',
  ...
  },
  {
    ...
    summary: 'Triage governed packages and safely recover AR, Partner sources, files, releases, and notifications.',
    section: 'Support',
    order: 70,
    reviewedAt: '2026-08-29',
