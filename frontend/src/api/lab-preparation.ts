...
export type PreparationDetail = PreparationSummary & { automaticSkipAvailable?: boolean; automaticSpecimenReferences?: boolean; optionalQcReports?: boolean; optionalPreparationReports?: boolean; bulkOutputs?: boolean; trayBarcode?: string | null; trayConfirmed?: boolean; notes?: string | null; layout: TrayLayout; labServiceWorkflowVersionId: string; stages: PreparationStage[]; members: PreparationMember[]; canOperate: boolean; canCorrect: boolean; roles: string[];
