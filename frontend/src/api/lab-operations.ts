...
export const createLabProtocol = (input: { key: string; name: string; description?: string }) => post<LabProtocol>('/platform/lab-operations/protocols', input)
...
export const transitionLabProtocolVersion = (id: string, action: string) => post<LabProtocolVersion>(`/platform/lab-operations/protocol-versions/${id}/transition`, { action })
...
export const printLabContainerLabel = (id: string) => post<LabContainer>(`/platform/lab-operations/containers/${id}/label-print`, {})
...
export const createLabBatch = (input: object) => post<LabBatch>('/platform/lab-operations/batches', input)
