...
export type LabContainer = { id: string; labSpecimenId: string | null; parentContainerId: string | null; kind: string; barcode: string; barcodeSource: 'PhaenoGenerated' | 'RegisteredSupplier' | 'Manufacturer'; externalBarcodeReferenceId: string | null; label: string; labelPrintCount: number; location: string | null; quantity: number | null; quantityUnit: string | null; status: string; retainUntilUtc: string | null; version: number; intakeDisposition?: string | null; intakeReasonCode?: string | null; intakeNotes?: string | null; intakeReviewedAtUtc?: string | null; intakeReviewedByUserId?: string | null; initialQuantity?: number | null; initialQuantityUnit?: string | null; quantityBasis?: string | null; quantityHistoryJson?: string }
