...
export type MaterialTransfer = {
  ...
  quantity: number; quantityUnit: string; sourceQuantityBefore: number | null; sourceQuantityAfter: number | null;
  sourceQuantityBasis: string | null; exhaustedOverride: boolean; balanceAdjustmentQuantity: number | null;
...
export type SequencingTubeCommand = {
  ...
  location?: string; quantity?: number; quantityUnit?: string; materialExhausted?: boolean; sourceVersion?: number; destinationVersion?: number;
