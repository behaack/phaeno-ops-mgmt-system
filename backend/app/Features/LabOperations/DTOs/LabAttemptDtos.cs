...
public sealed record LabAttemptDto(Guid Id, Guid SpecimenId, int Sequence, Guid? PreviousAttemptId,
    ...
    IReadOnlyList<LabAttemptStageSkip> StageSkips, IReadOnlyList<Guid> ExecutionIds, Guid? PreparationBatchId = null, Guid? WorkflowVersionId = null, string? WorkflowName = null, int? WorkflowVersion = null);
...
public sealed record LabAttemptWorkspaceDto(Guid WorkOrderId, string JobName, long WorkOrderVersion,
    ...
    IReadOnlyList<LabAttemptStageDto> Stages, IReadOnlyList<LabAttemptSpecimenDto> Specimens, Guid? DefaultWorkflowVersionId = null);
