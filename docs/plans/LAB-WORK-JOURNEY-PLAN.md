...
- The retired LAB-14 script described the manual acceptance journey at this checkpoint. Held/closed Trial races, every staff-role combination, physical tray/scanner/label handling and owner sign-off remain acceptance gates to re-scope against the current workflow. No provider processing, shared-database migration or production deployment was performed.
