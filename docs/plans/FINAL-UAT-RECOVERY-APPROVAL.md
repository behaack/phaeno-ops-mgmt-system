...
**September 17 final disposition: SYS-06 Pass; 81/81 software cases closed (40 ordinary, 41 explicitly simulated).** Actual schedule-event run `35113420745` succeeded with the newer September 16 host snapshot, matching authorized application/migration receipt, unexpired encrypted artifact `10453261809`, all three hashes and export receipt. The September 17 `collect-latest` fallback additionally secured today's fresh snapshot as artifact `10494054992`. Current API/UI source `52d21681517018ee77735e33e323518c808a27fd` matches the separately authorized invitation repair; Website identity remains unchanged and health checks pass. The owner-authorized conditional closure is satisfied. The completion checker is paused; daily host/GitHub backups remain enabled. Collection was delayed approximately 4 hours 22 minutes, so this is not an on-time service guarantee. Physical, scientific, provider-delivery and final business acceptance remain separate. [Full crosswalk and retained evidence](../testing/runs/2026-09-15-sys06-recovery.md).

### Historical checkpoints (superseded by final disposition)
