...
The representative surfaces are Company discovery, Company detail, Company edit, Trial scope, Customer sample roster, staff quote review, Partner Kit input, Finance allocation, protocol execution, protocol hold form, invitation and help. See [SYS-05](../10-recovery.md#sys-05--keyboard-responsive-ui-errors-and-draft-recovery) for the original requirements.
