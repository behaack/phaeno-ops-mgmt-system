...
| Phaeno | Operations orientation; Company People, requests, access and Department administration | Complete CRM; per-order Intake; Trial configuration and lifecycle; native Finance; Data provisioning; Lab receipt, accession, kit fulfillment, reagent manufacturing, Assembly and scientific work | Staged readiness, roles, controlled protocols, supplier-product and reagent inventory units, named storage locations, lot QC, lineage, scientific approval and separate release, shipping configuration, retention, Partner credit, and immutable commercial records | Context-preserving queues, approved-request completion, invitations, Lab handoffs, receipt evidence/import recovery, release and retention, and unavailable connectors |
