...
| Customer | Getting started; account and invitation delivery | Laboratory requests, samples, quotes, and cancellations | Governed PSeq result status, invoices, Data Library, and membership | Job, sample, quote, scan, invoice, and result troubleshooting |
...
| Phaeno | Operations orientation; organization and user administration | Commercial intake/staging and derived readiness; Data provisioning and governance; Lab receipt, accession, PSeq kit fulfillment, data assembly, and scientific execution | Explicit business/Lab roles, dual control, governed PSeq packages, native PSeq AR, Partner manual accounting, and retention evidence | Owned attention queues and safe invitation, accounting, projection, scan, release, and access recovery |
