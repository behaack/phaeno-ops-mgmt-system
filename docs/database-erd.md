...
erDiagram
    result_artifacts {
        ...
        character_varying_1000 result_locator "nullable"
    ...
    result_output_packages {
        ...
        character_varying_255 idempotency_key UK "not null"
        uuid lab_analysis_run_id FK "nullable"
        ...
        boolean traceability_required "not null"
    ...
    lab_analysis_runs o|--o{ result_output_packages : "lab_analysis_run_id"
...
erDiagram
    ...
    lab_service_orders {
        ...
        uuid sample_type_definition_id FK "nullable"
        character_varying_100 sample_type_material_class_snapshot "nullable"
        ...
        character_varying_2000 tenant_safe_reason "nullable"
        character_varying_100 tube_use_policy_key "nullable"
        integer tube_use_policy_version "nullable"
        timestamp_with_time_zone updated_at "not null"
        uuid updated_by_user_id "nullable"
        bigint version "not null"
        uuid shipping_destination_id FK "nullable; fixed exact revision"
        timestamp_with_time_zone shipping_destination_assigned_at "nullable"
    }
    lab_service_quotes {
        uuid id PK "not null"
    ...
    lab_analysis_runs o|--o{ lab_result_releases : "lab_analysis_run_id"
...
erDiagram
    ...
    order_system_configurations {
        uuid id PK "not null"
        uuid default_shipping_destination_definition_key "nullable; global Phaeno ship-to destination family"
        timestamp_with_time_zone created_at "not null"
        uuid created_by_user_id "nullable"
...
erDiagram
    ...
    sample_shipping_container_definitions {
        ...
        numeric_18_3 dry_ice_quantity "nullable; positive when used"
        character_varying_30 dry_ice_unit "nullable; paired with amount"
        ...
        character_varying_2000 temperature_control_instructions "nullable; required for Active use"
    ...
    sample_shipping_container_types {
        ...
        uuid sample_type_anchor_id FK "nullable; once linked cannot change"
...
erDiagram
    sample_shipping_stock_kits {
        ...
        uuid updated_by_user_id FK "nullable"
        bigint version "not null"
        timestamp_with_time_zone withdrawn_at "nullable"
        uuid withdrawn_by_user_id FK "nullable"
        character_varying_1000 withdrawal_reason "nullable"
    }
    ...
    users o|--o{ sample_shipping_stock_kits : "withdrawn_by_user_id"
...
erDiagram
    ...
    sample_type_procedure_links {
        uuid id PK "not null"
        uuid sample_type_anchor_id FK,UK "not null; first Sample type revision"
        uuid procedure_anchor_id FK "not null; first Procedure revision"
        timestamp_with_time_zone changed_at "not null"
        uuid changed_by_user_id FK "not null"
        timestamp_with_time_zone created_at "not null"
        uuid created_by_user_id "nullable"
    ...
    sample_shipping_procedures o|--o{ sample_type_definitions : "shipping_procedure_id"
    sample_type_definitions ||--o| sample_type_procedure_links : "sample_type_anchor_id"
    sample_shipping_procedures ||--o{ sample_type_procedure_links : "procedure_anchor_id"
    users ||--o{ sample_type_procedure_links : "changed_by_user_id"
...
erDiagram
    ...
    lab_performance_decisions {
        ...
        character_varying_4000 reason "not null"
        timestamp_with_time_zone reviewed_at_utc "not null"
        uuid reviewed_by_user_id "not null"
    }
    lab_performance_proposals {
        uuid id PK "not null"
        uuid based_on_proposal_id FK "nullable"
        character_varying_30 kind "not null"
        uuid lab_protocol_execution_id FK "not null"
        uuid lab_specimen_id FK "not null"
        uuid lab_work_order_id FK "not null"
        jsonb original_performance_json "not null"
        jsonb performance_json "not null"
        character_varying_4000 reason "not null"
        timestamp_with_time_zone requested_at_utc "not null"
        uuid requested_by_user_id "not null"
...
erDiagram
    lab_analysis_inputs {
        uuid id PK "not null"
        uuid lab_analysis_run_id FK,UK "not null"
        uuid lab_sequencing_output_id FK,UK "not null"
    }
    lab_analysis_runs {
        uuid id PK "not null"
        uuid lab_specimen_attempt_id FK "not null"
        uuid lab_specimen_id FK,UK "not null"
        uuid lab_work_order_id FK "not null"
        uuid previous_analysis_run_id FK "nullable"
        character_varying_100 provider_key UK "not null"
        character_varying_2000 reanalysis_reason "nullable"
        timestamp_with_time_zone recorded_at_utc "not null"
        character_varying_150 recorded_by_source "not null"
        uuid recorded_by_user_id "nullable"
        character_varying_64 request_sha256 "not null"
        jsonb requirements_snapshot_json "nullable"
        character_varying_255 run_reference UK "not null"
        jsonb scientific_evidence_json "nullable"
    }
    lab_attempt_command_receipts {
        uuid id PK "not null"
        uuid actor_user_id "not null"
        timestamp_with_time_zone applied_at_utc "not null"
        uuid lab_work_order_id FK "not null"
        character_varying_64 request_hash "not null"
    }
    ...
    lab_investigation_reports {
        uuid id PK "not null"
        text body_json "not null"
        integer format_version "not null"
        timestamp_with_time_zone generated_at_utc "not null"
        uuid generated_by_user_id "not null"
        uuid lab_specimen_id FK "not null"
        uuid lab_work_order_id FK "not null"
        character_varying_64 sha256 "not null"
    }
    ...
    lab_preparation_batches {
        uuid id PK "not null"
        timestamp_with_time_zone completed_at_utc "nullable"
        timestamp_with_time_zone created_at "not null"
        uuid created_by_user_id "nullable"
        uuid lab_service_workflow_version_id FK "not null"
        uuid lab_tray_format_id FK "not null"
        jsonb layout_json "not null"
    ...
    lab_specimens ||--o{ lab_analysis_runs : "lab_specimen_id"
    lab_work_orders ||--o{ lab_analysis_runs : "lab_work_order_id"
    lab_analysis_runs o|--o{ lab_analysis_runs : "previous_analysis_run_id"
    ...
    lab_specimens ||--o{ lab_investigation_reports : "lab_specimen_id"
    lab_work_orders ||--o{ lab_investigation_reports : "lab_work_order_id"
...
```mermaid
erDiagram
    lab_preparation_members {
        uuid id PK "not null"
        character_varying_100 confirmed_barcode "not null"
        ...
        boolean removed "not null"
    }
    lab_preparation_records {
        uuid id PK "not null"
        character_varying_50 action "not null"
        uuid actor_user_id "not null"
        jsonb details_json "not null"
        uuid lab_preparation_batch_id FK "not null"
        timestamp_with_time_zone recorded_at_utc "not null"
        character_varying_64 request_hash "not null"
    }
    lab_product_types {
    ...
    lab_sequencing_outputs {
        ...
        character_varying_64 external_identity_sha256 UK "not null"
    ...
    lab_specimen_attempts {
        uuid id PK "not null"
        timestamp_with_time_zone closed_at_utc "nullable"
        uuid closed_by_user_id "nullable"
        timestamp_with_time_zone created_at "not null"
        uuid created_by_user_id "nullable"
        uuid failed_execution_id FK "nullable"
        character_varying_4000 failure_evidence "nullable"
        character_varying_100 failure_reason_code "nullable"
        character_varying_2000 hold_next_action "nullable"
        uuid hold_owner_user_id "nullable"
        character_varying_2000 hold_reason "nullable"
        uuid lab_service_workflow_version_id FK "not null"
        uuid lab_specimen_id FK,UK "not null"
        uuid lab_work_order_id FK "not null"
        uuid previous_attempt_id FK "nullable"
    ...
    lab_steps {
        ...
        character_varying_255 name "not null"
        character_varying_255 normalized_name UK "not null; case-insensitive Lab step name uniqueness"
    ...
    lab_libraries ||--o{ lab_sequencing_outputs : "lab_library_id"
    lab_ngs_sendouts ||--o{ lab_sequencing_outputs : "lab_ngs_sendout_id"
    lab_specimen_attempts ||--o{ lab_sequencing_outputs : "lab_specimen_attempt_id"
    lab_specimens ||--o{ lab_sequencing_outputs : "lab_specimen_id"
    lab_work_orders ||--o{ lab_sequencing_outputs : "lab_work_order_id"
    lab_containers ||--o{ lab_sequencing_outputs : "source_container_id"
    lab_protocol_executions o|--o{ lab_specimen_attempts : "failed_execution_id"
    lab_service_workflow_versions ||--o{ lab_specimen_attempts : "lab_service_workflow_version_id"
    lab_specimens ||--o{ lab_specimen_attempts : "lab_specimen_id"
...
erDiagram
    ...
    lab_equipment_usages {
        ...
        uuid lab_preparation_record_id FK "nullable"
        uuid lab_protocol_execution_id FK "not null"
        jsonb resource_snapshot_json "nullable"
    ...
    lab_material_definitions {
        ...
        timestamp_with_time_zone created_at "not null"
        uuid created_by_user_id "nullable"
        character_varying_50 default_quantity_unit "nullable; set for reagent manufacturing"
        boolean is_active "not null"
        character_varying_100 key UK "not null"
        character_varying_50 kind "not null"
        character_varying_255 name "not null"
    ...
    lab_suppliers {
        ...
        uuid created_by_user_id "nullable"
        boolean is_active "not null"
        boolean is_internal_producer UK "not null; unique when true"
        character_varying_255 name "not null"
        character_varying_255 normalized_name UK "not null"
        timestamp_with_time_zone updated_at "not null"
        uuid updated_by_user_id "nullable"
    ...
    lab_reagent_manufacturing_runs {
        uuid id PK "not null"
        uuid workflow_id FK "not null"
        integer workflow_revision "not null"
        character_varying_160 workflow_name "not null"
        jsonb steps_json "not null"
        uuid material_lot_id FK,UK "not null"
        character_varying_30 status "not null"
        integer recorded_step_count "not null"
        integer material_use_count "not null"
        uuid started_by_user_id "not null"
        timestamp_with_time_zone started_at_utc "not null"
    ...
    lab_reagent_run_steps {
        uuid id PK "not null"
        uuid run_id FK,UK "not null"
        integer sequence UK "not null"
        character_varying_100 step_key "not null"
        character_varying_4000 notes "not null"
        uuid performed_by_user_id "not null"
        timestamp_with_time_zone performed_at_utc "not null"
    }
    lab_reagent_material_uses {
        uuid id PK "not null"
    ...
    lab_master_mix_workflows {
        uuid id PK "not null"
        character_varying_160 name UK "not null; unique while not retired"
        character_varying_50 quantity_unit "not null"
        jsonb steps_json "not null"
        jsonb ingredients_json "not null; frozen recipe requirements with exact decimal quantity text in each revision"
        jsonb revision_history_json "not null"
        integer revision "not null"
        character_varying_50 status "not null"
        uuid authored_by_user_id "not null"
        uuid approved_by_user_id "nullable"
    ...
    lab_master_mix_preparations {
        uuid id PK "not null"
        uuid workflow_id FK "not null"
        integer workflow_revision "not null"
        character_varying_160 workflow_name "not null"
        jsonb steps_json "not null"
        jsonb ingredients_json "not null; frozen approved recipe with exact decimal quantity text"
        character_varying_50 quantity_unit "not null"
        character_varying_50 status "not null"
        integer recorded_step_count "not null"
        integer ingredient_use_count "not null"
        numeric prepared_quantity "nullable"
        numeric used_quantity "not null"
        uuid started_by_user_id "not null"
        timestamp_with_time_zone started_at_utc "not null"
        timestamp_with_time_zone use_by_utc "not null; end of Los Angeles local day"
        uuid prepared_by_user_id "nullable"
        timestamp_with_time_zone prepared_at_utc "nullable"
        uuid discarded_by_user_id "nullable"
        timestamp_with_time_zone discarded_at_utc "nullable"
        numeric measured_discard_quantity "nullable"
        character_varying_2000 discard_reason "nullable"
        character_varying_2000 recipe_deviation_reason "nullable"
        uuid recipe_deviation_approved_by_user_id "nullable"
        timestamp_with_time_zone recipe_deviation_approved_at_utc "nullable"
        integer recipe_deviation_approved_ingredient_count "nullable"
        timestamp_with_time_zone created_at "not null"
        uuid created_by_user_id "nullable"
        timestamp_with_time_zone updated_at "not null"
        uuid updated_by_user_id "nullable"
    ...
    lab_master_mix_steps {
        uuid id PK "not null"
        uuid preparation_id FK,UK "not null; unique with sequence"
        integer sequence UK "not null; unique with preparation_id"
        character_varying_4000 notes "not null"
        uuid performed_by_user_id "not null"
        timestamp_with_time_zone performed_at_utc "not null"
    }
    ...
    lab_master_mix_tray_uses {
        ...
        uuid preparation_id FK "not null"
        uuid lab_preparation_batch_id FK "not null"
        uuid lab_preparation_record_id FK,UK "not null; unique with field_key"
        character_varying_100 field_key UK "not null; unique with lab_preparation_record_id"
        numeric quantity "not null"
        character_varying_50 quantity_unit "not null"
        uuid recorded_by_user_id "not null"
        timestamp_with_time_zone recorded_at_utc "not null"
    ...
    lab_master_mix_corrections {
        uuid id PK "not null"
        uuid preparation_id FK,UK "not null; unique with target_entry_id"
        uuid target_entry_id UK "not null; unique with preparation_id"
        character_varying_30 target_kind "not null; Ingredient or TrayUse"
        character_varying_30 action "not null; VerifiedVoid or Discrepancy"
        character_varying_2000 reason "not null"
        uuid recorded_by_user_id "not null"
        timestamp_with_time_zone recorded_at_utc "not null"
    }
    lab_equipment ||--o{ lab_equipment_usages : "lab_equipment_id"
    lab_preparation_records o|--o{ lab_equipment_usages : "lab_preparation_record_id"
    ...
    lab_preparation_records o|--o{ lab_material_consumptions : "lab_preparation_record_id"
    ...
    lab_material_definitions ||--o| lab_reagent_workflows : "material_definition_id"
    lab_reagent_workflows ||--o{ lab_reagent_manufacturing_runs : "workflow_id"
    lab_material_lots ||--o| lab_reagent_manufacturing_runs : "material_lot_id"
    ...
    lab_master_mix_workflows ||--o{ lab_master_mix_preparations : "workflow_id"
    lab_master_mix_preparations ||--o{ lab_master_mix_steps : "preparation_id"
    lab_master_mix_preparations ||--o{ lab_master_mix_ingredients : "preparation_id"
    lab_material_lots ||--o{ lab_master_mix_ingredients : "source_material_lot_id"
    lab_master_mix_preparations ||--o{ lab_master_mix_tray_uses : "preparation_id"
    lab_preparation_batches ||--o{ lab_master_mix_tray_uses : "lab_preparation_batch_id"
    lab_preparation_records ||--o{ lab_master_mix_tray_uses : "lab_preparation_record_id"
    lab_master_mix_preparations ||--o{ lab_master_mix_corrections : "preparation_id"
```
...
erDiagram
    ...
    lab_protocol_executions {
        ...
        uuid lab_service_workflow_stage_id FK,UK "nullable"
        uuid lab_specimen_attempt_id FK,UK "nullable"
    ...
    lab_service_workflow_versions {
        ...
        timestamp_with_time_zone created_at "not null"
        uuid created_by_user_id "nullable"
        timestamp_with_time_zone invalidated_at_utc "nullable"
        character_varying_2000 invalidation_reason "nullable"
...
erDiagram
    lab_containers {
        ...
        timestamp_with_time_zone intake_reviewed_at_utc "nullable"
        uuid intake_reviewed_by_user_id "nullable"
        character_varying_50 kind "not null"
        uuid lab_specimen_attempt_id FK "nullable"
        uuid lab_specimen_id FK "nullable"
        uuid lab_work_order_id FK "not null"
    ...
    lab_specimens {
        ...
        character_varying_2000 processing_next_action "nullable"
        character_varying_4000 processing_note "nullable"
        uuid processing_owner_user_id "nullable"
        character_varying_100 processing_reason_code "nullable"
        character_varying_50 processing_state "nullable"
        timestamp_with_time_zone processing_updated_at_utc "nullable"
        character_varying_1000 receipt_condition "nullable"
...
erDiagram
    lab_work_orders {
        ...
        timestamp_with_time_zone delivery_due_at_first_delivery_utc "nullable"
        timestamp_with_time_zone expected_completion_at_utc "nullable"
        timestamp_with_time_zone first_delivered_at_utc "nullable"
        ...
        timestamp_with_time_zone original_delivery_due_at_utc "nullable"
        timestamp_with_time_zone original_target_at_utc "nullable"
        bigint projection_version "not null"
        ...
        integer tube_use_policy_authorization_version "nullable"
        character_varying_100 tube_use_policy_key "nullable"
        integer tube_use_policy_version "nullable"
...
erDiagram
    web_contacts {
        ...
        character_varying_35 language "not null"
