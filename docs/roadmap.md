...
- `PLANS/ORGANIZATION-DATA-PROVISIONING-PLAN.md`: Phaeno source-sample registry, curated package governance, Prospect/Customer/Partner grants, and tenant access direction; implementation uses a synthetic test fixture while actual production data/profile approval remains a deployment-content step.
