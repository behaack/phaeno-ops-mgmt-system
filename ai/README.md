...
| Lab Operations, accessioning, protocols, reagent preparation, library preparation, NGS send-out, solution/schema restructuring, migration reset, provider contract, or future LIMS replacement | `docs/plans/LAB-OPERATIONS-PLAN.md`, `docs/plans/LAB-OPERATIONS-INVENTORY.md`, `docs/plans/LAB-OPERATIONS-CONTRACT.md`, `docs/plans/PSEQ-OPERATIONS-MIGRATION-PLAN.md`, `docs/lims-integration-strategy.md`, `docs/plans/ORDER-MANAGEMENT-PLAN.md`, and current Lab Operations and Order Management code; the approved internal application scope is feature-complete, including the `phaeno_ops` reset, Commercial/Laboratory schema separation, provider contract, full operator workflow, durable customer-safe projection delivery, current-order connection, user guides, and local migrations. Validation and production activation are incomplete: database-backed test execution, representative bench/label/scanner validation, external NGS operating details, deployment, and pipeline/file ownership remain explicit gates. |
