...
| Public Website API, contact/order inquiries, reCAPTCHA, Website search/crawler, Mailgun, public documents, or Website data cutover | `docs/plans/WEBSITE-API-CONSOLIDATION-PLAN.md`, `docs/operations-readiness.md`, `app/Features/Website`, the shared persistence code, and the current `phaeno-website` consumers; code is consolidated, while data and traffic cutover remain deployment work |
