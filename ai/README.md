...
| Lab Operations, accessioning, protocols, reagent preparation, library preparation, NGS send-out, solution/schema restructuring, migration reset, provider contract, or future LIMS replacement | `docs/plans/LAB-OPERATIONS-PLAN.md`, `docs/plans/LAB-OPERATIONS-INVENTORY.md`, `docs/plans/LAB-OPERATIONS-CONTRACT.md`, `docs/plans/PSEQ-OPERATIONS-MIGRATION-PLAN.md`, `docs/lims-integration-strategy.md`, `docs/plans/ORDER-MANAGEMENT-PLAN.md`, and current Order Management code; inventory/classification, the planned v1 contract, solution/project/context restructuring, Commercial extractions, the disposable Development reset, and the single clean `InitialPSeqOperations` baseline are complete. Mixed Commercial/Laboratory/pipeline records and real Lab Operations implementation remain explicitly deferred |
