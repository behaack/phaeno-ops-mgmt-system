...
| File management, orders, or provisioning | the corresponding `PLANS/` file and current feature code; the provisioning first slice, EF migration, and rollback-safe PostgreSQL reference journey are implemented, while order models remain proposed |
