...
| Lab Operations, accessioning, protocols, reagent preparation, library preparation, NGS send-out, solution/schema restructuring, migration reset, provider contract, or future LIMS replacement | `docs/plans/LAB-OPERATIONS-PLAN.md`, `docs/plans/LAB-OPERATIONS-INVENTORY.md`, `docs/plans/LAB-OPERATIONS-CONTRACT.md`, `docs/plans/PSEQ-OPERATIONS-MIGRATION-PLAN.md`, `docs/lims-integration-strategy.md`, `docs/plans/ORDER-MANAGEMENT-PLAN.md`, and current Lab Operations and Order Management code; the `phaeno_ops` reset, Commercial/Laboratory schema separation, provider contract, full internal operator workflow, durable customer-safe projection delivery, current-order connection, user guides, and local migrations are complete. Production bench validation, deployment, a future external LIMS adapter, and pipeline/file ownership remain explicit gates. |
