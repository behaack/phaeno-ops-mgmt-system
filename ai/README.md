...
| Lab Operations, accessioning, protocols, reagent preparation, library preparation, NGS send-out, solution/schema restructuring, migration reset, provider contract, or future LIMS replacement | `docs/plans/LAB-OPERATIONS-PLAN.md`, `docs/plans/LAB-OPERATIONS-INVENTORY.md`, `docs/plans/LAB-OPERATIONS-CONTRACT.md`, `docs/plans/PSEQ-OPERATIONS-MIGRATION-PLAN.md`, `docs/lims-integration-strategy.md`, `docs/plans/ORDER-MANAGEMENT-PLAN.md`, and current Order Management code; inventory/classification, the planned v1 contract, the clean development-reset sequence, solution/project shells, the single-context schema target, and the Accounts Commercial extraction are complete, but remaining feature extraction, the destructive development reset, clean initial migration, and Lab Operations implementation remain pending |
