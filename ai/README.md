...
| Lab Operations, accessioning, protocols, reagent preparation, library preparation, NGS send-out, or future LIMS replacement | `docs/plans/LAB-OPERATIONS-PLAN.md`, `docs/lims-integration-strategy.md`, `docs/plans/ORDER-MANAGEMENT-PLAN.md`, and current Order Management code; the separate Lab Operations module is approved planning direction but is not implemented |
